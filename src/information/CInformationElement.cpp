...
// -------------------------------------------------------------------------------
{
   ...
   debug( "[CInformationElement::encrypt] before *****" );
   debug( "[CInformationElement::encrypt] mInformation='" + mInformation + "'" );
   debug( "[CInformationElement::encrypt] mEncryptedData='" + mEncryptedData + "'" );
   debugTrace( "---" );

   StringCrypter::encryptString( mInformation, msTmpPasswd, mEncryptedData );
   mInformation = "";

   debug( "[CInformationElement::encrypt] after *****" );
   debug( "[CInformationElement::encrypt] mInformation='" + mInformation + "'" );
   debug( "[CInformationElement::encrypt] mEncryptedData='" + mEncryptedData + "'" );
   debugTrace( "---" );
}
...
// -------------------------------------------------------------------------------
{
   debugWarn( "[CInformationElement::decrypt] mInformation='" + mInformation + "'" );
   debugErr( "[CInformationElement::decrypt] mEncryptedData='" + mEncryptedData + "'" );
   debugTrace( "---" );
