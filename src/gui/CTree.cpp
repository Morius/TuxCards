...
// -------------------------------------------------------------------------------
{
   ...
   // print all available mime formats
   //foreach( QString sFormat, pEvent->mimeData()->formats() )
   //   debug( "[CTree::dragMoveEvent] mimeData format = " + sFormat );
...
// -------------------------------------------------------------------------------
{
   ...
   // print all available mime formats
   foreach( QString sFormat, pEvent->mimeData()->formats() )
      debug( "[CTree::dropEvent] mimeData format = " + sFormat );
