...
#include "ui_IConfigurationDialog.h"
...
private slots:
   ...
   void         slotChangePredefinedFont1();
   void         slotChangePredefinedFont2();
   void         slotChangePredefinedFont3();
   void         slotChangePredefinedFont4();
   void         slotChangePredefinedFont5();
   void         slotDeletePredefinedFont1();
   void         slotDeletePredefinedFont2();
   void         slotDeletePredefinedFont3();
   void         slotDeletePredefinedFont4();
   void         slotDeletePredefinedFont5();
...
private:
   ...
   void         setPredefinedFont  ( QLabel& label, QToolButton& button, const QString& sPrefix );
   void         setPredefinedFont  ( QLabel& label, QToolButton& button, const QString& sPrefix, const QString& sFont );
   void         resetPredefinedFont( QLabel& label, QToolButton& button );
