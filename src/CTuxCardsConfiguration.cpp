...
// -------------------------------------------------------------------------------
{
   ...
   QSettings settings( TUX_ORGANISATION, TUX_APPLICATION_NAME );
   debug( "[CTuxCardsConfiguration] load settings from config file '" + settings.fileName() + "'" );
   ...
   mStringMap[S_FLOWER_DIR]         = settings.value("Flower_Dir", ":/").toString();
   ...
   mStringMap[S_PREDEFINED_FONT_1]  = settings.value("Editor_PredefinedFont_1", "").toString();
   //debug( "[CTuxCardsConfiguration::readConfigurationFile] Editor_PredefinedFont_1='" + mStringMap[S_PREDEFINED_FONT_1] + "'" );
   mStringMap[S_PREDEFINED_FONT_2]  = settings.value("Editor_PredefinedFont_2", "").toString();
   //debug( "[CTuxCardsConfiguration::readConfigurationFile] Editor_PredefinedFont_2='" + mStringMap[S_PREDEFINED_FONT_2] + "'" );
   mStringMap[S_PREDEFINED_FONT_3]  = settings.value("Editor_PredefinedFont_3", "").toString();
   //debug( "[CTuxCardsConfiguration::readConfigurationFile] Editor_PredefinedFont_3='" + mStringMap[S_PREDEFINED_FONT_3] + "'" );
   mStringMap[S_PREDEFINED_FONT_4]  = settings.value("Editor_PredefinedFont_4", "").toString();
   //debug( "[CTuxCardsConfiguration::readConfigurationFile] Editor_PredefinedFont_4='" + mStringMap[S_PREDEFINED_FONT_4] + "'" );
   mStringMap[S_PREDEFINED_FONT_5]  = settings.value("Editor_PredefinedFont_5", "").toString();
   //debug( "[CTuxCardsConfiguration::readConfigurationFile] Editor_PredefinedFont_5='" + mStringMap[S_PREDEFINED_FONT_5] + "'" );
   //settings.endGroup();
...
// -------------------------------------------------------------------------------
{
   ...
   QSettings settings( TUX_ORGANISATION, TUX_APPLICATION_NAME );
   debug( "[CTuxCardsConfiguration] save settings to '" + settings.fileName() + "'" );
   ...
   settings.setValue("Editor_PredefinedFont_1",  mStringMap[S_PREDEFINED_FONT_1] );
   //debug( "[CTuxCardsConfiguration::saveToFile] Editor_PredefinedFont_1='" + mStringMap[S_PREDEFINED_FONT_1] + "'" );
   settings.setValue("Editor_PredefinedFont_2",  mStringMap[S_PREDEFINED_FONT_2] );
   //debug( "[CTuxCardsConfiguration::saveToFile] Editor_PredefinedFont_2='" + mStringMap[S_PREDEFINED_FONT_2] + "'" );
   settings.setValue("Editor_PredefinedFont_3",  mStringMap[S_PREDEFINED_FONT_3] );
   //debug( "[CTuxCardsConfiguration::saveToFile] Editor_PredefinedFont_3='" + mStringMap[S_PREDEFINED_FONT_3] + "'" );
   settings.setValue("Editor_PredefinedFont_4",  mStringMap[S_PREDEFINED_FONT_4] );
   //debug( "[CTuxCardsConfiguration::saveToFile] Editor_PredefinedFont_4='" + mStringMap[S_PREDEFINED_FONT_4] + "'" );
   settings.setValue("Editor_PredefinedFont_5",  mStringMap[S_PREDEFINED_FONT_5] );
   //debug( "[CTuxCardsConfiguration::saveToFile] Editor_PredefinedFont_5='" + mStringMap[S_PREDEFINED_FONT_5] + "'" );
   //settings.endGroup();
